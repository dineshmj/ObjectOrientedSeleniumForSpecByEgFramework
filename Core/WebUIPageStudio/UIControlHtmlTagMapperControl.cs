...
namespace OOSelenium.WebUIPageStudio
{
		...
		: UserControl
	{
		...
		public bool IsNameValid
		{
			get
			{
				if (pageModelPropertyNameTextBox.Text.IsNullEmptyOrWhitespace ())
				{
					return false;
				}
		...
		private void doNotInitializeInConstructorCheckBox_CheckedChanged (object sender, EventArgs e)
		{
			this.DoNotInitializeInConstructor = this.doNotInitializeInConstructorCheckBox.Checked;
		}
	}
}
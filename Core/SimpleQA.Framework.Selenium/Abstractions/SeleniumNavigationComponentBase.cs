...
using SimpleQA.Framework.Selenium.Entities;
...
namespace SimpleQA.Framework.Selenium.Abstractions
{
	...
	public abstract class SeleniumNavigationComponentBase<TUserRole, TExecutionEnvironment>
		: IWebUiNavigationComponent<TUserRole, TExecutionEnvironment>
		where TUserRole : Enum
		where TExecutionEnvironment : Enum
	{
		private readonly IConfigurationRoot appSettings;

		// Properties.
		public IEnvironmentDataProvider<TUserRole, TExecutionEnvironment> EnvironmentDataProvider { get; protected set; }
		...
		// Constructors.
		protected SeleniumNavigationComponentBase (
			IWebUiNavigationComponent<TUserRole, TExecutionEnvironment> parentNavigationComponent)
				: this (parentNavigationComponent.EnvironmentDataProvider, parentNavigationComponent.Decryptor)
		{
		}

		protected SeleniumNavigationComponentBase
			(
				IEnvironmentDataProvider<TUserRole, TExecutionEnvironment> exeEnvDataProvider,
			...
			)
		{
			...
			this.EnvironmentDataProvider = exeEnvDataProvider;

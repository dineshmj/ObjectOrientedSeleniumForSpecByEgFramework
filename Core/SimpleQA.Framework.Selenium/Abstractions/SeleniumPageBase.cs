...
namespace SimpleQA.Framework.Selenium.Abstractions
{
		...
		: IDisposable
	{
		...
		{
			public static readonly string FindRadioButtonGroupByName = nameof (SeleniumPageBase.FindRadioButtonGroupByName);
			public static readonly string FindDropDownListByXPath = nameof (SeleniumPageBase.FindDropDownListByXPath);
			public static readonly string FindMultiSelectListBoxByXPath = nameof (SeleniumPageBase.FindMultiSelectListBoxByXPath);
		}
		...
		// Constructor.
		public SeleniumPageBase (IWebDriver webDriver, string baseUrl, bool navigationRequired = false, bool maximizeWindow = true)
		{

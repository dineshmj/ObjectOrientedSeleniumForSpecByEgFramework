...
using SimpleQA.UseCases.Selenium.WebUITests.LetsKodeTests.Background;
using SimpleQA.UseCases.Selenium.WebUITests.LetsKodeTests.Navigation;
...
namespace SimpleQA.UseCases.Selenium.WebUITests.LetsKodeTests.Tests
{
	public sealed class LetsKodeUiPracticeTests
		: SeleniumWebUiTestBase
	{
		private readonly IEnvironmentDataProvider<UserRole, Environment> letsKodeDataProvider;
		private readonly LetsKodeNavigationComponent<UserRole, Environment> letsKodeNavigationComponent;
		...
		public LetsKodeUiPracticeTests ()
		{
			...
			letsKodeNavigationComponent
				= new LetsKodeNavigationComponent<UserRole, Environment> (letsKodeDataProvider);
		}
